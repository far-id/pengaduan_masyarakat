                    ...
                    <div class="card-body">
                        ...
                        @endphp
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea rows="3" name="aduan" disabled class="form-control" required autofocus minlength="30">{{ $p->tanggapan }}</textarea>
                                </div>
                                <div class="form-group">
                                    <label>Tanggal Ditanggapi</label>
                                    <input type="text" class="form-control" disabled value="{{ $p->updated_at }}">
                                </div>

            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-body">
                        ...
                        @endphp
                            <form action="{{ route('tanggapiAspi', $p->id) }}" method="post">
                                @csrf
                                ...
                                <div class="form-check form-check-inline">
                                    <div class="col">
                                        <label class="radio">Terima
                                            <input type="radio" checked="checked" name="radio" value="Terima">
                                            <span class="checkmark"></span>
                                        </label>
                                    </div>
                                    <div class="col">
                                        <label class="radio">Tolak
                                            <input type="radio" name="radio" value="Tolak">
                                            <span class="checkmark"></span>
                                        </label>
                                    </div>
                                </div>
